...
import com.zhuravskii_khanov.student_planner2.data.Subject
import com.zhuravskii_khanov.student_planner2.data.sampleSubjects
        ...
        topBar = {
            TopAppBar(
                title = { Text("Мои дисциплины")},
                 actions = {
                     IconButton(onClick = onRaspisClick) {
                         Icon(
